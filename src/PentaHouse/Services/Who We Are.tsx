...
export default function WhoWeAre() {
  ...
  return (
    <section ref={containerRef} className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
      <div className="who-text w-full lg:w-5/12 space-y-6">
        <h3 className="text-[#CBA052] font-bold tracking-widest text-xs uppercase">Who We Are</h3>
      ...
      <div className="w-full lg:w-7/12 relative h-[400px] lg:h-[500px]">
        {/* Background Image */}
        <div className="who-bg absolute top-0 right-0 w-[80%] h-[300px] lg:h-[400px]">
          <img 
        ...
        <div className="who-fg absolute bottom-0 left-0 w-[70%] h-[250px] lg:h-[350px] shadow-2xl shadow-black/80">
          <img 
            src="https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&w=600&q=80" 
            alt="Happy clients in home" 
            className="w-full h-full object-cover rounded-sm border-[4px] border-[#0a0a0a]"
          />
        </div>
      </div>
    </section>
